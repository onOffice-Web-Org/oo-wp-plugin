...
class InputModelBuilderDefaultValueEstate
{
	/** */
	...
	/** @var InputModelDBFactoryConfigEstate */
	private $_pInputModelDBFactoryConfigEstate;


	/**
	 *
	 * @param InputModelDBFactoryConfigEstate $pInputModelDBFactoryConfigEstate
	 *
	 */

	public function __construct(InputModelDBFactoryConfigEstate $pInputModelDBFactoryConfigEstate)
	{
		$this->_pInputModelDBFactoryConfigEstate = $pInputModelDBFactoryConfigEstate;
	}
