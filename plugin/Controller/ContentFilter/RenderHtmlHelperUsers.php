...
class RenderHtmlHelperUsers
{
    ...
    public static function renderHtmlHelperUserIfEmptyId(string $type, string $documentationLink, string $linkDetail = null, array $pDataDetail): string
    {
        ...
        $description = sprintf(__("The plugin couldn't find any %1\$s. Please make sure that you have published some %2\$s, as described in the %3\$s", 'onoffice-for-wp-websites'), $type, $type, $linkDetail);
