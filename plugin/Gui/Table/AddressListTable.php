	...
	extends ListTable
{
	...
	{
		return '<input type="text" style="max-width: 100%; margin-right: 5px;" readonly value="[oo_address view=&quot;'.esc_html($pItem->name).'&quot;]"><input type="button" class="button button-copy" data-clipboard-text="[oo_address view=&quot;' . esc_html( $pItem->name ) . '&quot;]" value="' . esc_html__( 'Copy',
