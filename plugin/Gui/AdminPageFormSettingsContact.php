	...
	extends AdminPageFormSettingsBase
{
	...
	protected function buildForms()
	{
		...
		if ($this->_showCheckDuplicates) {
			...
			$pInputModel->setHint(__('Be aware that when activated the duplicate checkcan overwrite address records. This function will be removed in the future. Use at your own risk.', 'onoffice-for-wp-websites'));
			$pFormModelFormSpecific->addInputModel($pInputModel);
		}
