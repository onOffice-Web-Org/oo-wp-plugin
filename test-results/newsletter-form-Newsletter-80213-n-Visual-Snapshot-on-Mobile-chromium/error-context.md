...
- Name: newsletter-form.spec.ts >> Newsletter Formular: Multi-Theme Engine & Visual Regression >> Theme: onoffice-modern >> Visual: Snapshot on Mobile
...
Timeout: 5000ms
  ...
  Snapshot: newsletter-form-onoffice-modern-Mobile.png

Call log:
  - Expect "toHaveScreenshot(newsletter-form-onoffice-modern-Mobile.png)" with timeout 5000ms
    - generating new stable screenshot expectation
  - waiting for locator('form').filter({ has: locator('input[name="oo_formid"][value="Newsletter"]') })
    - waiting for" http://localhost/e2e-test-formulare/newsletterformular/?force_theme=onoffice-modern&e2e_key=qa_rocks&t=1782309644778" navigation to finish...
    - navigated to "http://localhost/e2e-test-formulare/newsletterformular/?force_theme=onoffice-modern&e2e_key=qa_rocks&t=1782309644778"
  - Timeout 5000ms exceeded.
