...
- Name: newsletter-form.spec.ts >> Newsletter Formular: Multi-Theme Engine & Visual Regression >> Theme: onoffice-modern >> Functional Scenarios >> Newsletter: Email Validation
- Location: tests-e2e/specs/newsletter-form.spec.ts:99:21
...
Call log:
  ...
  - waiting for locator('form').filter({ has: locator('input[name="oo_formid"][value="Newsletter"]') }).locator('input[type="email"]').first()
    - waiting for" http://localhost/e2e-test-formulare/newsletterformular/?force_theme=onoffice-modern&e2e_key=qa_rocks&t=1782309661440" navigation to finish...
    - navigated to "http://localhost/e2e-test-formulare/newsletterformular/?force_theme=onoffice-modern&e2e_key=qa_rocks&t=1782309661440"
