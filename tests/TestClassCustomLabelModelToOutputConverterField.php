 ...
 *
 */
class TestClassCustomLabelModelToOutputConverterField
	extends WP_UnitTestCase
{
	...
	public function testConvert(string $currentLocale, CustomLabelModelField $pModel, array $expectation)
	{
		$this->_pLanguage->expects($this->once())->method('getLocale')->will($this->returnValue($currentLocale));
		$pConverter = new CustomLabelModelToOutputConverterField($this->_pLanguage);
	...
	public function generateTestData(): Generator
	{
		...
		$pModel = new CustomLabelModelField(13, $pField);
