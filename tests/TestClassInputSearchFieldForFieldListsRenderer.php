	...
	extends WP_UnitTestCase
{
	...
	public function testRenderWithValues()
	{
		...
		$pSubject->render();
		$output = ob_get_clean();
		$this->assertEquals('<div class="box-search"><input type="text" class="input-search"><span class="dashicons dashicons-search clear-icon" id="clear-input"></span></div><label>Search the field list for the desired fields.</label><div class="field-lists"><div class="line-bottom-content"></div><ul class="search-field-list"><li class="search-field-item" data-label="Field 1" data-key="field1" data-content="Content 1"><span class="field-item inputFieldButton labelButtonHandleField-field1"name="testRenderer"data-onoffice-module="address"value="field1"data-onoffice-category="Content 1"data-onoffice-label="Field 1"id="labelsearchFieldForFieldLists_1bfield1"><span class="dashicons dashicons-insert check-action" typeField="1"></span><div class="field-item-detail" style="opacity: 1;"><span>Content 1</span><h4>Field 1 (field1)</h4></span></div></li><li class="search-field-item" data-label="Field 2" data-key="field2" data-content="Content 2"><span class="field-item inputFieldButton labelButtonHandleField-field2"name="testRenderer"data-onoffice-module="address"value="field2"data-onoffice-category="Content 2"data-onoffice-label="Field 2"id="labelsearchFieldForFieldLists_1bfield2"><span class="dashicons dashicons-insert check-action" typeField="1"></span><div class="field-item-detail" style="opacity: 1;"><span>Content 2</span><h4>Field 2 (field2)</h4></span></div></li></ul></div>', $output);
	}
