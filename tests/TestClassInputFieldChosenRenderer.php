	...
	extends \WP_UnitTestCase
{
	...
	public function testRenderMultiple()
	{
		...
		$pSubject->render();
		$output = ob_get_clean();
		$this->assertEquals('<select name="testRenderer[]" id="select_1" multiple style="width: 50%;"></select>', $output);
	}
	...
	public function testRenderNotMultiple()
	{
		...
		$pSubject->render();
		$output = ob_get_clean();
		$this->assertEquals('<select name="testRenderer" id="select_1" style="width: 50%;"></select>', $output);
	}
	...
	public function testRenderWithValues()
	{
		...
		$pSubject->render();
		$output = ob_get_clean();
		$this->assertEquals('<select name="testRenderer[]" id="select_1" multiple style="width: 50%;">'
	...
	public function testRenderSingleSelectedValue()
	{
		...
		$pSubject->render();
		$output = ob_get_clean();
		$this->assertEquals('<select name="testRenderer" id="select_1" style="width: 50%;">'
		                    .'<optgroup label="Popular">'
		                    .'<option value="kaufpreis" selected="selected">Kaufpreis</option>'
		                    .'<option value="kaltmiete" >Kaltmiete</option>'
		                    .'</optgroup>'
