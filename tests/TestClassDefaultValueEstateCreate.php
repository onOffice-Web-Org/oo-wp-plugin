...
class TestClassDefaultValueEstateCreate
	extends WP_UnitTestCase
{
	...
	public function prepare()
	{
		...
		$this->_pSubject = new DefaultValueEstateCreate($this->_pRecordManagerFactory);
	}
	...
	public function testCreateForSingleselect()
	{
		...
		$this->_pRecordManagerInsertGeneric->expects($this->exactly(2))->method('insertByRow')
			->will($this->returnCallback(function(array $values) {
				if ($values === ['oo_plugin_fieldconfig_estate_defaults' => ['estate_id' => 3, 'fieldname' => 'testField1']]) {
					return 13;
				}
				if ($values === ['oo_plugin_fieldconfig_estate_defaults_values' => [
	...
	public function testCreateForMultiselect()
	{
		$this->_pRecordManagerInsertGeneric->expects($this->exactly(3))->method('insertByRow')
				->will($this->returnCallback(function(array $values) {
				$valuesConf = [
					12 => ['oo_plugin_fieldconfig_estate_defaults' => ['estate_id' => 14, 'fieldname' => 'testField2']],
					55 => ['oo_plugin_fieldconfig_estate_defaults_values' => ['defaults_id' => 12, 'locale' => '', 'value' => '123']],
					56 => ['oo_plugin_fieldconfig_estate_defaults_values' => ['defaults_id' => 12, 'locale' => '', 'value' => 'abc']],
				];
	...
	public function testCreateForText()
	{
		$this->_pRecordManagerInsertGeneric->expects($this->exactly(3))->method('insertByRow')
			->will($this->returnCallback(function(array $values) {
				$valuesConf = [
					121 => ['oo_plugin_fieldconfig_estate_defaults' => ['estate_id' => 14, 'fieldname' => 'testField2']],
					130 => ['oo_plugin_fieldconfig_estate_defaults_values' => [
						'defaults_id' => 121, 'locale' => 'de_DE', 'value' => 'Aachen']
					],
					56 => ['oo_plugin_fieldconfig_estate_defaults_values' => [
	...
	public function testCreateForNumericRange()
	{
		$this->_pRecordManagerInsertGeneric->expects($this->exactly(3))->method('insertByRow')
			->will($this->returnCallback(function(array $values) {
				$valuesConf = [
					122 => ['oo_plugin_fieldconfig_estate_defaults' => ['estate_id' => 14, 'fieldname' => 'testField3']],
					130 => ['oo_plugin_fieldconfig_estate_defaults_values' => [
	...
	public function testCreateForDate()
	{
		$this->_pRecordManagerInsertGeneric->expects($this->exactly(3))->method('insertByRow')
			->will($this->returnCallback(function(array $values) {
				$valuesConf = [
					122 => ['oo_plugin_fieldconfig_estate_defaults' => ['estate_id' => 14, 'fieldname' => 'testField3']],
					130 => ['oo_plugin_fieldconfig_estate_defaults_values' => [
						'defaults_id' => 121, 'locale' => '', 'value' => '2023/04/18']
					],
					56 => ['oo_plugin_fieldconfig_estate_defaults_values' => [
						'defaults_id' => 121, 'locale' => '', 'value' => '2023/04/19']
					],
				];
				$returnValue = array_search($values, $valuesConf);
				return $returnValue ?: 0;
		...
		$pField = new Field('testField3', 'testModule2');
		$pDefaultValues = new DefaultValueModelDate(14, $pField);
		$pDefaultValues->setValueFrom('2023/04/18');
		$pDefaultValues->setValueTo('2023/04/19');
		$resultId = $this->_pSubject->createForDate($pDefaultValues);
		$this->assertEquals(122, $resultId);
		$this->assertEquals(122, $pDefaultValues->getDefaultsId());
	}
}
