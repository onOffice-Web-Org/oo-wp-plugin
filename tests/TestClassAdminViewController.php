	...
	extends WP_UnitTestCase
{
	...
	public function testEnqueueExtraJs(AdminViewController $pAdminViewController)
	{
		...
		$this->assertEquals(['handle-notification-actions', 'admin-js', 'postbox', 'oo-copy-shortcode', 'onoffice-custom-form-label-js', 'onoffice-multiselect', 'oo-unsaved-changes-message', 'onoffice-bulk-actions-fields'], wp_scripts()->queue);
	}
...
We recommend that you go to the <a href='http://example.org/wp-admin/admin.php?page=onoffice-settings#notice-seo' target='_blank' rel='noopener'>onOffice plugin settings</a> and configure the onOffice plugin to not modify the title and description. This allows you to manage the title and description with your active SEO plugin.</p></div>");
	...
	public function testEnqueueExtraJsWithHandleRecaptcha(AdminViewController $pAdminViewController)
	{
		...
		$this->assertEquals(['handle-notification-actions', 'handle-visibility-google-recaptcha-keys', 'oo-unsaved-changes-message'], wp_scripts()->queue);
	}
}
