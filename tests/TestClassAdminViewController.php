...
We recommend that you go to the <a href='<a href=\"http://example.org/wp-admin/admin.php?page=onoffice-settings\">http://example.org/wp-admin/admin.php?page=onoffice-settings</a>' target='_blank' rel='noopener'>onOffice plugin settings</a> and configure the onOffice plugin to not modify the title and description. This allows you to manage the title and description with your active SEO plugin.</p></div>");
	}
