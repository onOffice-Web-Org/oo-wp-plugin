...
class TestClassInputModelBuilderDefaultValueEstate
	extends \WP_UnitTestCase
{
	/** @var InputModelBuilderDefaultValueEstate */
	...
	{
		$pInputModelDBFactoryConfigEstate = new InputModelDBFactoryConfigEstate;
		$this->_pSubject = new InputModelBuilderDefaultValueEstate($pInputModelDBFactoryConfigEstate);
	}
	...
	public function testValueCallback(Closure $pClosure)
	{
		...
		$pClosure($pInputModel, 'testFieldDate');
		$this->assertEquals(InputModelBase::HTML_TYPE_TEXT, $pInputModel->getHtmlType());
