...
Description: Your connection to onOffice: This plugin enables you to have quick access to estates and forms – no additional sync with the software is needed. Consult support@onoffice.de for source code. Test-Änderung sichtbar.
Version: 6.16.0
Requires PHP: 8.2
License: AGPL 3+
...
const ONOFFICE_PLUGIN_VERSION = '6.16.0';
